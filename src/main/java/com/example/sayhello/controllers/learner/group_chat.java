...
public class group_chat implements Initializable {
        ...
        if (infoFile2.exists()) {
            ...
            while (scanner.hasNext()) {
                ...
                if (lineCount % 2 == 0) {
                    ...
                    String senderMessage = line;

                    message msg = new message(senderImg, senderMessage);
    ...
    public void btn_insert(MouseEvent event) throws IOException {
        ...
        writer.write( learner2.getProfile_img() + "\n");
        writer.write(t + "\n");
        writer.close();

        message msg = new message( learner2.getProfile_img() , t);
        inboxObservableList.add(msg);
    }
