...
public class course_details implements Initializable {
    ...
    void go_group_chat(MouseEvent event) throws IOException {
        ...
        AnchorPane fxml = FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("fxml/learner/group_chat.fxml")));
    ...
    void go_online_class(MouseEvent event) throws IOException {
        ...
        AnchorPane fxml = FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("fxml/learner/online_class.fxml")));
        danchore.getChildren().removeAll();
        danchore.getChildren().setAll(fxml);
    }
    ...
    void go_study_material(MouseEvent event) throws IOException {
        AnchorPane fxml = FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("fxml/learner/study_material.fxml")));
        danchore.getChildren().removeAll();
        danchore.getChildren().setAll(fxml);
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            fxml = FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("fxml/learner/online_class.fxml")));
        } catch (IOException e) {
