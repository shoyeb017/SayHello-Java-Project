...
public class study_material_cell_controller implements Initializable
{
    ...
    public void web(ActionEvent event) throws Exception
    {
        ...
        if(study1.getType().equals("Video"))
        {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("fxml/instructor/video_player.fxml"));
    ...
    public void go_inbox ()  {
        ...
        View_manager view = new View_manager();
        FXMLLoader fxmlLoader = new FXMLLoader(HelloApplication.class.getResource("fxml/instructor/study_material_cell_bar_view.fxml"));
